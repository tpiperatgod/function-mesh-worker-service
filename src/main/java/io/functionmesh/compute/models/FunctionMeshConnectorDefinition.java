...
public class FunctionMeshConnectorDefinition extends ConnectorDefinition {
    ...
    /**
     * Jar or nar package name of the connector, optional.
     * If not set, will be generated by id and version.
     */
    ...
    public String getJar() {
        return StringUtils.isNotBlank(jarFullName) ? String.format("connectors/%s", jarFullName) :
                String.format("connectors/%s-%s.nar", id, version);
    }
